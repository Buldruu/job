...
export default function Mergejilten() {
  ...
  const filtered = workers.filter(w => {
    ...
    const ms = !s || (w.ner||'').toLowerCase().includes(s)
            ...
            <button key={w.id} onClick={()=>setSelected(w)}
              ...
              <div className="flex items-start gap-3 mb-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-display font-bold text-teal-800">
              ...
              <StarDisplay rating={avgRating(w.ratings)} count={(w.ratings||[]).length}/>
          ...
          <div className="relative bg-white rounded-2xl shadow-card-hover p-6 w-full max-w-md z-10 animate-fade-up border border-surf-200">
            ...
            <div className="space-y-2 max-h-64 overflow-y-auto pr-1">
              {[
                ...
                {label:'Сургалтын газар', value:selected.surgaltin_gazar},
